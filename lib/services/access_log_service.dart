...
class AccessLogService {
  // Instancia singleton para compartir la bitácora entre pantallas
  static final AccessLogService _instance = AccessLogService._internal();
  factory AccessLogService() => _instance;
